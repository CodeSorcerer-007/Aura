...
export const CommandPalette = ({ isOpen, onClose, commands }) => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/80 backdrop-blur-lg z-[90] flex items-start justify-center pt-20 p-4" style={{ WebkitAppRegion: 'no-drag' }}>
