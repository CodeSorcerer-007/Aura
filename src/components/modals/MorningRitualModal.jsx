...
/**
 * MorningRitualModal — Shown once per day on first open.
 * Prompts user to select their 3 Most Important Tasks.
 */
export const MorningRitualModal = ({ isOpen, tasks, onClose, onSetMITs }) => {
