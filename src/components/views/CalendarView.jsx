...
import { CalendarIcon, ChevronUpIcon, ChevronDownIcon, CheckIcon, ZapIcon, StarIcon } from '../icons/Icons';

export const CalendarView = ({ tasks, toggleTask, onFocus, onOpenDetail, allCategories }) => {
